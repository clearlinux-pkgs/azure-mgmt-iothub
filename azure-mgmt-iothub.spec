...
Source0  : https://files.pythonhosted.org/packages/28/d2/6868d49c45ddc6bdd8b85d45044ce7ba7373d4524981413c806aada18955/azure-mgmt-iothub-0.12.0.zip
Summary  : Microsoft Azure IoTHub Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-iothub-python = %{version}-%{release}
Requires: azure-mgmt-iothub-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-iothub package.
Group: Default
Requires: azure-mgmt-iothub-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-iothub package.


%package python3
Summary: python3 components for the azure-mgmt-iothub package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_iothub)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-iothub package.


%prep
%setup -q -n azure-mgmt-iothub-0.12.0
cd %{_builddir}/azure-mgmt-iothub-0.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608046583
